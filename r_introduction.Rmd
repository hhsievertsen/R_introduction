...
- `labels=c(1985 = "A year", 1996="A Different Year")`: Instead of showing the actual values as tick mark labels, we create new labels to show. 
...
```{r ch5-quiz2}
quiz(
  question("What is the  average income share in 2015?",
           answer("0.1929810"),
           answer("0.1429810	"),
...
`r emo::ji("nerd_face")` **Code example: wid_uk_b50**
